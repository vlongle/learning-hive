...
result_dir = "/mnt/kostas-graid/datasets/vlongle/learning_hive/experiment_results/latest_main_no_init_tasks_no_backward_replay_jorge_setting_recv_variable_shared_memory_size/mem_size_200_comm_freq_9_num_queries_20_assign_labels_groundtruth"
