...
LOCAL_FOLDERS=("/mnt/kostas-graid/datasets/vlongle/experiment_results/jorge_setting_lowest_task_id_wins_modmod_test_sync_base_True_opt_with_random_False_frozen_False_transfer_decoder_False_transfer_structure_False_no_sparse_basis_True" "/mnt/kostas-graid/datasets/vlongle/experiment_results/jorge_setting_lowest_task_id_wins_modmod_test_sync_base_True_opt_with_random_False_frozen_False_transfer_decoder_False_transfer_structure_True_no_sparse_basis_True" "/mnt/kostas-graid/datasets/vlongle/experiment_results/jorge_setting_lowest_task_id_wins_modmod_test_sync_base_True_opt_with_random_False_frozen_False_transfer_decoder_True_transfer_structure_False_no_sparse_basis_True" "/mnt/kostas-graid/datasets/vlongle/experiment_results/jorge_setting_lowest_task_id_wins_modmod_test_sync_base_True_opt_with_random_False_frozen_False_transfer_decoder_True_transfer_structure_True_no_sparse_basis_True")
REMOTE_USER="vlongle"
