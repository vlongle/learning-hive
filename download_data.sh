...
# LOCAL_FOLDERS=("/mnt/kostas-graid/datasets/vlongle/learning_hive/rerun_no_sparse_basis_recv_results")
LOCAL_FOLDERS=("/mnt/kostas-graid/datasets/vlongle/learning_hive/rerun_no_sparse_basis_recv_results_groundtruth_no_sync_base")
# LOCAL_FOLDERS=("/mnt/kostas-graid/datasets/vlongle/learning_hive/rerun_no_sparse_basis_recv_results_same_as_query")
#LOCAL_FOLDERS=("/mnt/kostas-graid/datasets/vlongle/learning_hive/more_fl_fix_root_agent_results")
LOCAL_FOLDERS=("/mnt/kostas-graid/datasets/vlongle/learning_hive/rerun_no_sparse_basis_false_recv_results_groundtruth_sync_base_True")
LOCAL_FOLDERS=("/mnt/kostas-graid/datasets/vlongle/learning_hive/rerun_same_setting")
LOCAL_FOLDERS=("/mnt/kostas-graid/datasets/vlongle/fedfish_results")
REMOTE_USER="vlongle"
