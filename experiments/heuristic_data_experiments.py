...
if __name__ == "__main__":
    ...
    if args.dataset != "cifar100":
        ...
        config = {
            ...
            "root_save_dir": root_save_dir,
            "root_save_dir": prefix + f"cifar_heuristic_results_small_mem_{memory_size}/budget/heuristic_budget_{args.budget}_enforce_balance_{args.enforce_balance}_mem_{shared_memory_size}_sync_base_{sync_base}_hash_{args.hash_data}_comm_freq_{comm_freq}",
            "sharing_strategy": "heuristic_data",
            "sharing_strategy.shared_memory_size": shared_memory_size,
            "sharing_strategy.comm_freq": comm_freq,
            "sharing_strategy.sync_base": sync_base,
